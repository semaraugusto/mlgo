...
const (
	RWKV_FILE_VERSION           = 101
	RWKV_FILE_MAGIC_WRONG       = 0x67676a74 // 'ggjt' in hex
	RWKV_FILE_MAGIC             = 0x67676d66 // 'ggmf' in hex
	RWKV_FILE_MAGIC_UNVERSIONED = 0x67676d6c // 'ggml' pre-versioned files
...
var (
	...
	RWKV_V5_N_PARTS = map[uint32]int{
		4096: 1,
		// 5120: 2,
		// 6656: 4,
		// 8192: 8,
...
func LoadModel(
	...
	fmt.Println("\n[INFO] Model file version:", version)
	if version != RWKV_FILE_VERSION {
